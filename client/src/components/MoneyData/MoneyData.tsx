...
export default function MoneyData({ totalIncome, totalExpense }: Readonly<SliderProps>) {
    return (
        <div className='money-data-container'>
            <div className='amount-display reverse'>
                ...
                <div className="amount-display-amount safe-to-spend alt-grey">{totalIncome - totalExpense < 0 ? "-" : ""}${Math.abs(totalIncome - totalExpense)}</div>
            </div>
            <div className='money-ex-bu'>
                <div className='amount-display'>
                    <div className="amount-display-title">Budget</div>
                    <div className="amount-display-amount">${totalIncome}</div>
                </div>
                <div className='amount-display'>
                    <div className="amount-display-title">Expense</div>
                    <div className="amount-display-amount alt-red">{totalExpense === 0 ? "" : "-"}${totalExpense}</div>
                </div>
            </div>
