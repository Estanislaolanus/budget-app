            ...
            <div className="lists">
                <div className="budget-list list">
                    <div className="list-header">
                        <div className="list-title">Income List</div>
                        <button onClick={() => setTransaction("income")} className="add add-1">
                    ...
                    <div className="list-body">
                        {
                            <DisplayListSection key="income" typeOfTransaction={"income"} expenseArray={expenseArray} incomeArray={incomeArray} updateTransactionArray={updateTransactionArray} deleteTransaction={deleteTransaction} />
                        }
                    </div>
                </div>
                <div className="expense-list list">
                    ...
                    <div className="list-body">
                        {
                            <DisplayListSection key="expense" typeOfTransaction={"expense"} incomeArray={incomeArray} expenseArray={expenseArray} updateTransactionArray={updateTransactionArray} deleteTransaction={deleteTransaction} />
                        }
                    </div>
                </div>
            </div>
